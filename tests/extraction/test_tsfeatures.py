"""
Test suite for the feature extraction using tsfeatures.
...
from src.extraction.tsfeatures import FeatureExtractor
...
@pytest.mark.skip(reason="Feature extraction takes ~ 20 minutes")
def test_extraction_single_sampling_frequency() -> None:
    ...
    try:
        ...
        assert extracted_features.shape[1] == 45 * 43
...
@pytest.mark.skip(reason="Feature extraction takes > 60 minutes")
def test_extraction_different_sampling_frequencies() -> None:
    ...
    try:
        ...
        assert extracted_features.shape[1] == 43 * 17
